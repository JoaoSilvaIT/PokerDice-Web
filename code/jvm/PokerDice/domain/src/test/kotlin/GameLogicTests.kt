...
class GameLogicTests {
    ...
    fun `test four of a kind`() {
        val hand = Hand(listOf(
            Dice(Face.ACE), Dice(Face.ACE), Dice(Face.ACE), Dice(Face.ACE), Dice(Face.KING)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test full house`() {
        val hand = Hand(listOf(
            Dice(Face.ACE), Dice(Face.ACE), Dice(Face.ACE), Dice(Face.KING), Dice(Face.KING)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test three of a kind`() {
        val hand = Hand(listOf(
            Dice(Face.ACE), Dice(Face.ACE), Dice(Face.ACE), Dice(Face.KING), Dice(Face.QUEEN)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test two pair`() {
        val hand = Hand(listOf(
            Dice(Face.ACE), Dice(Face.ACE), Dice(Face.KING), Dice(Face.KING), Dice(Face.QUEEN)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test one pair`() {
        val hand = Hand(listOf(
            Dice(Face.ACE), Dice(Face.ACE), Dice(Face.KING), Dice(Face.QUEEN), Dice(Face.JACK)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test high dice`() {
        val hand = Hand(listOf(
            Dice(Face.NINE), Dice(Face.KING), Dice(Face.QUEEN), Dice(Face.JACK), Dice(Face.TEN)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
    ...
    fun `test straight`() {
        val hand = Hand(listOf(
            Dice(Face.KING), Dice(Face.QUEEN), Dice(Face.JACK), Dice(Face.TEN), Dice(Face.ACE)
        ))
        val (_, rank) = gameLogic.defineHandRank(hand)
