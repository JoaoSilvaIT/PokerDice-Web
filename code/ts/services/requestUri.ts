...
export const RequestUri = {
    ...
    game: {
        ...
        nextTurn: (gameId: number) => `${BASE_API_URL}/games/${gameId}/rounds/next-turn`,
        ante: (gameId: number) => `${BASE_API_URL}/games/${gameId}/rounds/ante`,
        payAnte: (gameId: number) => `${BASE_API_URL}/games/${gameId}/rounds/pay-ante`,
        start: (gameId: number) => `${BASE_API_URL}/games/${gameId}/start`,
