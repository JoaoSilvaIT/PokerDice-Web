        ...
        <div className="about-container">
            <div className="about-content">
                ...
                <section>
                    <h2>The Game</h2>
                    <p>
                        PokerDice is a multiplayer dice game that combines the mechanics of poker with the excitement of dice rolling.
                ...
                <section>
                    ...
                    <p>
                        <strong>3. Roll & Hold:</strong> You have up to 3 rolls per turn. After the first roll, you can choose to hold specific dice and re-roll the others to improve your hand.
                    </p>
                    <p>
                        <strong>4. Win:</strong> The player with the highest-ranking hand at the end of the round wins the pot!
                    </p>
                </section>
